        ...
        public async void Execute()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    await RepeatAction(1, async () => await TransferDuplicatePokemon(true));
                    await RepeatAction(1, async () => await RecycleItems());
                    await RepeatAction(1, async () => await EvolveAllPokemonWithEnoughCandy());
